...
class world:
    ...
    def __init__(self,tilemap):
        ...
        for y in range(self.altura + tamanho_hud): #EXISTE FORMA MAIS FACIL DE FAZER ISSO, MAS TO COM PREGUIÇA DE REFAZER COM UM for PERDÃO CLEO/BICHO
            ...
            for x in range(self.largura):
                ...
                elif self.tilemap.pget(x,y) == worldItem.parede3:
                    self.mapa_mundo[-1].append(worldItem.parede3)
